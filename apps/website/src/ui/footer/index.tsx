...
const Footer = async ({ locale }: { locale: string }) => {
  const { t } = await useTranslationServer(locale)
            ...
            <div className="mb-12 max-w-[600px] lg:mb-16">
              ...
              <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                <Trans
                  ...
                  i18nKey="footer.text"
                  components={[
                    <Link key="footer-text-link" href="/" className="hover:text-primary" />,
                  ]}
                />
              </p>
        ...
        <div className="container">
          <p className="text-center text-base text-body-color dark:text-white">
            <Trans
              ...
              values={{ year: 2023 }}
              components={[
                <Link key="footer-copyright-link" href="/" className="hover:text-primary" />,
              ]}
            />
          </p>
        </div>
